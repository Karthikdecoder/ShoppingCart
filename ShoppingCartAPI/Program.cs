...
builder.Services.AddDbContext<ApplicationDbContext>(option => // here the connection is passed inside paramater '(....)' which can be accessed using constructor in appdbcontext
{
